...
class AppRepository(private val database: SortimentDatabase) {
    ...
    fun exampleData(){
        ...
        sortiment.add(Artikel(artikelBezeichnung = "Pro Tech Toolkit", preis = 74.99, artikelBeschreibung = "In unserem hochwertigen Pro Tech Toolkit findest du alle Werkzeuge, die du für die Reparatur von Smartphone brauchst.", bild = R.drawable.toolkits, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "iOpener", preis = 12.99, artikelBeschreibung = "Mit dem iOpener löst du problemlos und schnell Klebeverbindungen, ohne das Risiko, mit einer Heißluftpistole und zu viel Hitze dein Gerät zu beschädigen. ", bild = R.drawable.toolkitsiopener, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "Essential Electronics Toolkit", preis = 29.99, artikelBeschreibung = "Unser Essential Electronics Toolkit bringt deswegen alles mit, was du für die meisten Elektronikreparaturen benötigst. Kompakt und immer griffbereit.", bild = R.drawable.toolkitsessential, anleitungPdf = "", kategorie = "Werkzeug"))
        ...
        sortiment.add(Artikel(artikelBezeichnung = "Pro Tech Diagnose", preis = 69.99, artikelBeschreibung = "Am besten untersuchst du die Ursache mit unserem Pro Tech Diagnose Kit, um deine Fehlersuche sicher und fachmännisch durchzuführen.", bild = R.drawable.toolkitsdiagnose, anleitungPdf = "", kategorie = "Werkzeug"))

        // Sortiment Werkzeug Schraubendreherwerkzeug

        sortiment.add(Artikel(artikelBezeichnung = "4MM Schraubendreher-Bit", preis = 2.95, artikelBeschreibung = "Die FunRepair 4 mm Präzisions-Bits wurden mit einem längeren Schaft konzipiert, um eine größere und präzisere Reichweite zu ermöglichen", bild = R.drawable.schraubendreherbit4mm, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "4mm Bithalter aus Aluminium", preis = 9.95, artikelBeschreibung = "Bithalter aus Aluminium passend für 4 mm Bits.", bild = R.drawable.schraubendreherbithalter4mm, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "P5 Pentalobe Schraubendreher", preis = 5.95, artikelBeschreibung = "Dein präziser P5 Pentalobe Schraubendreher, um dein iPhone zu öffnen.", bild = R.drawable.schraubendreherpentalobe, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "Schraubenentferner-Set", preis = 19.95, artikelBeschreibung = "Entferne rundgedrehte Schrauben ohne Beschädigungen am Gerät.", bild = R.drawable.schraubendreherentfernerset, anleitungPdf = "", kategorie = "Werkzeug"))
        ...
        sortiment.add(Artikel(artikelBezeichnung = "Werkzeugset zum Hebeln", preis = 9.95, artikelBeschreibung = "Besser, du greifst direkt zum passenden Spezialwerkzeug aus biegsamem aber robustem Kunststoff – genau wie wir es im Werkzeugset zum Hebeln und Öffnen zusammengestellt haben.", bild = R.drawable.hebelset, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "Hebelfreund Jimmy", preis = 7.95, artikelBeschreibung = "Dabei muss das gar nicht sein, wenn du nur unseren Jimmy griffbereit hast – denn mit diesem praktischen Helfer im Hosentaschenformat bekommst du fast jedes elektronische Gerät mühelos auf.", bild = R.drawable.hebeljimmy, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "Anti Clamp Hebelkit", preis = 24.95, artikelBeschreibung = "Diese Klemme heißt Anti-Clamp (liebevoll Clampy genannt), die wir zur neuen Königin der Geräteöffnung gekrönt haben. Die Herrscherin über den gläsernen Thron, wenn du so willst.", bild = R.drawable.hebelanticlamp, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "iSesamo Opening Tool", preis = 9.95, artikelBeschreibung = "Die Klinge aus Federstahl besitzt eine clevere Hebelspitze und ein besonders rutschfestes Griffstück.", bild = R.drawable.hebelisesamo, anleitungPdf = "", kategorie = "Werkzeug"))
        sortiment.add(Artikel(artikelBezeichnung = "Steinel Heißluftgebläse", preis = 34.95, artikelBeschreibung = "Bestens geeignet zum Aufschmelzen von Lötverbindungen und Klebstoffen", bild = R.drawable.hebelsteinel, anleitungPdf = "", kategorie = "Werkzeug"))
